...
HD_PWD='C:/Users/Asus/Downloads/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log variant2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source variant2.tcl
